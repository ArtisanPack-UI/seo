...
class UpdateSeoMetaRequest extends FormRequest
{
	...
	public function rules(): array
	{
		return [
			...
			'pinterest_description'   => [ 'nullable', 'string' ],
			'pinterest_image'         => [ 'nullable', 'string', 'max:500' ],
			'pinterest_image_id'      => [ 'nullable', 'integer' ],
			'slack_title'             => [ 'nullable', 'string', 'max:255' ],
			'slack_description'       => [ 'nullable', 'string' ],
			'slack_image'             => [ 'nullable', 'string', 'max:500' ],
			'slack_image_id'          => [ 'nullable', 'integer' ],
